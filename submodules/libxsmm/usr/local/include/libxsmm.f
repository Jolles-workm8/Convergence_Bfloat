...
!=======================================================================!
     ...
     &    C_FUNPTR, C_NULL_FUNPTR, C_NULL_PTR
        ...
        CHARACTER(*), PARAMETER :: LIBXSMM_VERSION = "1.16.2-1953"
        !> Name of the branch of which the version is derived from.
        CHARACTER(*), PARAMETER :: LIBXSMM_BRANCH = "aarch64"
        ...
        INTEGER(C_INT), PARAMETER :: LIBXSMM_VERSION_UPDATE = 2
        !> Patch number counting commits since the last version stamp.
        INTEGER(C_INT), PARAMETER :: LIBXSMM_VERSION_PATCH = 1953
