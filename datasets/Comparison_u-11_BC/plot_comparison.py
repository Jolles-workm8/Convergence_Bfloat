...
df1 = pd.read_csv("../Best_case/2x2_matrix_frobenius.csv")
...
df1 = pd.read_csv("../Best_case/4x4_matrix_frobenius.csv")
...
df1 = pd.read_csv("../Best_case/8x8_matrix_frobenius.csv")
...
df1 = pd.read_csv("../Best_case/16x16_matrix_frobenius.csv")
...
df1 = pd.read_csv("../Best_case/32x32_matrix_frobenius.csv")
...
df1 = pd.read_csv("../Best_case/64x64_matrix_frobenius.csv")
...
plt.plot(x, fp_best, label = "fp32", linestyle="-", color="darkred")
#plt.plot(x, fp_worst, label = "fp32 u[1,1,00005]", linestyle="-", color="orangered")
plt.plot(x, Z0_best, label= "Z0 u[-1,1]", linestyle="--", color="darkorange")
plt.plot(x, Z0_worst, label = "Z0 u[1,1,00005]",linestyle="--", color="yellow")
plt.plot(x, Z1_best, label= "Z1 u[-1,1]",linestyle="-.", color="darkblue")
plt.plot(x, Z1_worst, label = "Z1 u[1,1,00005]",linestyle="-.", color="deepskyblue")
plt.plot(x, Z2_best, label= "Z2 u[-1,1]",linestyle=":", color="darkgreen")
#plt.plot(x, Z2_worst, label = "Z2 u[1,1,00005]",linestyle=":", color="lime")

plt.yscale('log')
plt.xlabel('matrix sizes')
plt.ylabel('accuracy')
plt.legend()
plt.title('Comparison between u[-1,1] and u[1,1,00005]')
